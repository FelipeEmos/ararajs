...
import type {
  TriggerAraraProps as DialogTriggerAraraProps,
...
export type PopoverTriggerAraraProps = DialogTriggerAraraProps
...
export type PopoverTriggerElementProps = PopoverTriggerSharedElementProps & {
  ...
  'data-arara-popover-trigger': ''
} & DialogTriggerElementProps

export type PopoverTriggerProps<T extends ValidComponent = 'button'> =
  PopoverTriggerAraraProps & Partial<PopoverTriggerSharedElementProps<T>>

/** Button that changes the open state of the popover when clicked.
 *
 * @data `data-arara-popover-trigger` - Present on every popover trigger element.
