...
import araraRedImage from '@assets/examples/arara_red.jpg'
...
> 🚧 AraraJS is still in its very early stages🐣. Please be aware of that. Suggestions are very welcome and appreciated, please reach out in SolidJS' <Link href="https://discord.com/invite/solidjs" newTab>Discord Channel</Link> or write an <Link href="https://github.com/FelipeEmos/ararajs/issues" newTab>Issue</Link> if you think its' more suited.
...
AraraJS's signals can also be derived and combined in cleaver ways. A simple combination can emerge new exciting behavior which you'll have full control of. Look at what is possible with only <Link href="">spring</Link> and <Link href="">sine wave</Link> primitives combined together with the mouse position.

<div class="w-full flex justify-center">
<HoverCard client:load imgSrc={araraRedImage.src} class="max-w-64" />
</div>
