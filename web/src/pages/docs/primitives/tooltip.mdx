...
image: https://arara.dev/primitives/tooltip.jpg
---
...
<PackageInfo packageName="@arara/tooltip" />
...
<Code code={`
npm install @arara/tooltip
`} lang="bash" copyButton />

The tooltip is also included in the main `arara` package under `arara/tooltip`.

## Usage
<Code code={`
import Tooltip from '@arara/tooltip' // 'arara/tooltip'
// or
// import { Root, Trigger, ... } from '@arara/tooltip'
`} lang="tsx" copyButton />
