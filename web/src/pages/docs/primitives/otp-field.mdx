...
image: https://arara.dev/primitives/otp-field.jpg
---
...
<PackageInfo packageName="@arara/otp-field" />
...
<Code code={`
npm install @arara/otp-field
`} lang="bash" copyButton />

The OTP Field is also included in the main `arara` package under `arara/otp-field`.

## Usage
<Code code={`
import OtpField from '@arara/otp-field' // 'arara/otp-field'
// or
// import { Root, Input } from '@arara/otp-field'
`} lang="tsx" copyButton />

The OTP Field primitive renders an invisible input field (`<OtpField.Input />`) on top of the visible slots. This allows you to style the input field as you like while keeping the input field accessible. arara takes care of syncing the selection, focus and hover states between the input and your UI.
