...
image: https://arara.dev/primitives/popover.jpg
---
...
<PackageInfo packageName="@arara/popover" />
...
<Code code={`
npm install @arara/popover
`} lang="bash" copyButton />

The popover is also included in the main `arara` package under `arara/popover`.

## Usage
<Code code={`
import Popover from '@arara/popover' // 'arara/popover'
// or
// import { Root, Trigger, ... } from '@arara/popover'
`} lang="tsx" copyButton />
